...
import teste.lucasvegi.pokemongo.Util.ViewUnitsUtil;
import teste.lucasvegi.pokemongo.View.CameraPreview;
                ...
                if(countSound < maxCount) {
                    ...
                    mp2.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mp) {
                            //TODO: tratar cenário em que o banco local persistir o pokemon capturado mas o servidor não
                            ...
                            try {
                                //Sobe informações da captura para o servidor
                                ClientServerUtil clientServerUtil = new ClientServerUtil(ClientServerUtil.CAPTURAR,
                                        "Enviando dados para o servidor...",
                                        ControladoraFachadaSingleton.getInstance().getUsuario(),
                                        ap,
                                        dtCap,
                                        CapturaActivity.this);

                                clientServerUtil.execute();

                            }catch (Exception e){
                                Log.e("ASYNC_TASK", "Erro: " + e.getMessage());
                            }
